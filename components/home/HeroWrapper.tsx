...
const HeroWrapper: FC = () => {
    ...
    const { execute: extractText, status: extractingStatus } = useAction(extractTextAction, {
        onError: (err) => toast.error('Failed to extract text: ' + err),
    });
    ...
    const { execute: analyzeCV, status: analyzingStatus } = useAction(analyzeCVAction, {
        ...
        onError: (err) => toast.error('Analysis failed: ' + err),
    });
    ...
    const handleUploadAndAnalyze = async () => {
        ...
        await analyzeCV({ content: extractionResult! });
    };
